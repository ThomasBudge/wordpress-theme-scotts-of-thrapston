<div class="video">
    <div class="video__container">
        ...
        <div class="video__video" style="background-image:url('<?= get_template_directory_uri() . '/resources/img/video-thumbnail.jpg' ?>');">
            <button class="video__play">
                <svg xmlns="http://www.w3.org/2000/svg" width="140.009" height="140.009" viewBox="0 0 140.009 140.009">
